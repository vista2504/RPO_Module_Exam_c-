...
---
# ИНЦИДЕНТ №[4]:[Неполное Логирование.]
## СИМПТОМ:
Файлы логов отражают недостаточно информации.
## ПРИЧИНА:
В коде недостаточно эпизодов записи логов, нужные сведенья не записываются.
## РЕШЕНИЕ:
В код были добавлены несколько строк, фиксирующих успешное и провальное выполнение функции.
## КОММИТ:
aa8a3fe508d1865fc3405c4b37abccb497bb8eee
