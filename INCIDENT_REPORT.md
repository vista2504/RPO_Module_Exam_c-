...
---
# ИНЦИДЕНТ №[3]:[Считывание .env файл.]
## СИМПТОМ:
При запуске проекта пользователь видит ошибку "Произашла ошибка при загрузке данных."
## ПРИЧИНА:
При просмотре кода была выявлена проблема с чтением .env файла.
## РЕШЕНИЕ:
В код была добавлена строчка: ``Env.TraversePath().Load("secret.env");``
## КОММИТ:
aa8a3fe508d1865fc3405c4b37abccb497bb8eee
